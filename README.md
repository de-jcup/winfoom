...
> 👉 Note: For Windows systems there is `winfoom-windows.zip` archive containing only the Windows executable files, that comes with AdoptOpenJDK v11 (the `jdk` directory), so you don't have to install anything.
